package 数据结构与算法.algorithm.tree;
...
public class BinaryTree<Key extends Comparable<Key>, Value> {
    ...
    public Node delete(Node x,Key key){
        ...
        //x树不为null
            ...
            if(cmp>0){
                ...
                //如果key等于x结点的键，完成真正的删除动作，要删除的结点就是x
    ...
    private Node min(Node x){
        //判断x中还有没有左子结点，如果有，则继续向左找，如果没有，则x就是最小键所在的结点
        if(x.left!=null){
            return min(x.left);
        }else{
            return x;
    ...
    private Node max(Node x){
        //判断x中还有没有右子结点，如果有，则继续向右找，如果没有，则x就是最大键所在的结点
        if(x.left!=null){
            return max(x.right);
        }else{
            return x;
    ...
    public Queue<Key> layerErgodic(){
        ...
        while(!nodes.isEmpty()){
            ...
            keys.enqueue(n.key);
            //判断当前结点还有没有左子结点，如果有就放入到nodes中
            if(n.left!=null){
                nodes.enqueue(n.left);
            }
            //判断当前结点还有没有右子结点，如果右就放入到nodes中
            if(n.right!=null){
